...
class FoodViewController: UIViewController {
    ...
    var foodSelected : String = "" // Passed from ShopsViewController table
    ...
    override func viewDidLoad() {
        ...
        selectedFood = foodSelected.replacingOccurrences(of: "’", with: "'", options: .regularExpression, range: nil)
        selectedFood = selectedFood.trimmingCharacters(in: CharacterSet.whitespacesAndNewlines)
...
extension FoodViewController : CLLocationManagerDelegate {
    ...
    func getLocations() {
        ...
        request.naturalLanguageQuery = selectedFood
 ...
 */
extension FoodViewController : MKMapViewDelegate {
